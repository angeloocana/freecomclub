...
declare module '~express~path-to-regexp/index' {
...
import {Options, Token} from '~express~path-to-regexp/index';
...
declare module '~express~serve-static/index' {
...
import serveStatic = require('~express~serve-static/index');
